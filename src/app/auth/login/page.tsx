        ...
        <div className="border border-gray-200 rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-gray-900 hover:bg-gray-800 disabled:opacity-50 rounded-lg font-semibold text-white transition"
            >
              {loading ? '登录中...' : '登录'}
            </button>
          </form>
          ...
          <button
            ...
            className="w-full py-2.5 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-lg text-gray-700 font-medium transition flex items-center justify-center gap-2"
          >
          ...
          <p className="text-sm text-gray-400 text-center mt-6">
            还没有账号？<Link href="/auth/register" className="text-gray-900 hover:text-gray-700 font-medium">注册</Link>
          </p>
        </div>
      </div>
    </div>
